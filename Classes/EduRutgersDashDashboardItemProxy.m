...
@implementation EduRutgersDashDashboardItemProxy
...
-(void)setItem:(RutgersLauncherItem*)item_
{
	if (item!=nil)
	{
		item.userData = nil;
...
-(RutgersLauncherItem*)ensureItem
{
	if (item==nil)
	{
		item = [[RutgersLauncherItem alloc] init];
		item.userData = self;
	}
	return item;
}
...
-(void)add:(id)child
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        RutgersLauncherItem *item_ = [self  ensureItem];
        if (item_.view==nil)
        {
